...
>(({ className, children, ...props }, ref) => {
  const id = React.useId(); // Добавлено для генерации уникальных ID
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        aria-describedby={`dialog-description-${id}`} // Использование уникального ID для aria-describedby
        className={cn(
      ...
      >
        ...
        <DialogPrimitive.Description id={`dialog-description-${id}`} className="sr-only">
          Описание диалога
        </DialogPrimitive.Description> {/* Добавлено описание диалога */}
      </DialogPrimitive.Content>
    </DialogPortal>
  )
})
